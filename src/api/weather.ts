...
import type { CurrentWeather, HourlyForecast, DailyForecast, AQIData, WeatherData, Coordinates } from '@/types/weather'
import { getAQIData, getAQIColor } from '@/lib/utils'
